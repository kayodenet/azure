    ...
    TUNNELS = [
      {
        ike = {
          ...
          dest    = azurerm_public_ip.hub2_vpngw_pip0.ip_address
        },
        ipsec = {
          peer_ip = azurerm_public_ip.hub2_vpngw_pip0.ip_address
          psk     = local.psk
        }
      },
      {
        ike = {
          ...
          source  = local.branch3_nva_ext_addr
          dest    = azurerm_public_ip.hub2_vpngw_pip1.ip_address
        },
        ipsec = {
          peer_ip = azurerm_public_ip.hub2_vpngw_pip1.ip_address
          psk     = local.psk
        }
      },
    ]
