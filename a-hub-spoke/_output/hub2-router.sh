...
interface Loopback1
ip address 10.22.4.99 255.255.255.255
!
...
ip route 10.22.3.4 255.255.255.255 10.22.1.1
ip route 10.22.3.5 255.255.255.255 10.22.1.1
ip route 10.5.0.0 255.255.0.0 10.22.1.1
ip route 10.6.0.0 255.255.0.0 10.22.1.1
!
route-map NEXT-HOP permit 100
match ip address prefix-list all
set ip next-hop 10.22.4.99
!
router bgp 65000
bgp router-id 10.22.1.9
neighbor 10.22.3.4 remote-as 65515
neighbor 10.22.3.4 ebgp-multihop 255
neighbor 10.22.3.4 soft-reconfiguration inbound
neighbor 10.22.3.4 as-override
neighbor 10.22.3.4 route-map NEXT-HOP out
neighbor 10.22.3.5 remote-as 65515
neighbor 10.22.3.5 ebgp-multihop 255
neighbor 10.22.3.5 soft-reconfiguration inbound
neighbor 10.22.3.5 as-override
neighbor 10.22.3.5 route-map NEXT-HOP out
