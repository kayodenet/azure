...
server:
        ...
        # local data records
        local-data: "branch1-vm.contoso.com 3600 IN A 10.10.0.5"
        local-data: "branch2-vm.contoso.com 3600 IN A 10.20.0.5"
        local-data: "branch3-vm.contoso.com 3600 IN A 10.30.0.5"
        local-data: "branch4-vm.contoso.com 3600 IN A 10.40.0.5"
