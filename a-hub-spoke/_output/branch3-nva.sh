...
peer 168.63.63.84
address 168.63.63.84
pre-shared-key changeme
peer 20.238.40.117
address 20.238.40.117
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.30.1.9
match identity remote address 168.63.63.84 255.255.255.255
match identity remote address 20.238.40.117 255.255.255.255
...
tunnel destination 168.63.63.84
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 20.238.40.117
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
...
neighbor 10.22.2.4 remote-as 65515
